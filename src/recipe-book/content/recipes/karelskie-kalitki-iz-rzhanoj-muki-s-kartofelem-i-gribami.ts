...
export const karelskieKalitkiIzRzhanojMukiSKartofelemIGribami: NewRecipe = {
  title: "Карельские калитки из ржаной муки с картофелем и грибами",
  description:
  ...
  calories: 175,
  servings: 12,
  tools: ["Противень", "Нож", "Миска", "Разделочная доска", "Сковорода"],
  ingredients: [
    {
      name: "мука ржаная",
      note: "",
